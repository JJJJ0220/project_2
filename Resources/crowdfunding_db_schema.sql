...
1.	The database crowdfunding_db was created

2.	The following four tables were created in this order: 
	category, subcategory,contacts, campaign
	
3.	The following CSV files: category.csv, subcategory.csv, contacts.csv and campaign.csv were imported to their
	respective named tables
*/

-- 1. CREATE DATABASE: crowdfunding_db
...
--=============================
--2. CODE TO CREATE CATEGORY TABLE
...
--=================================
--3. CODE TO CREATE SUBCATEGORY TABLE
...
--4. CODE TO CREATE CONTACTS TABLE
...
--5. CODE TO CREATE CAMPAIGN TABLE
